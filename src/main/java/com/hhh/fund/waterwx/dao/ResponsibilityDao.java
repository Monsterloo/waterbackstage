...
public interface ResponsibilityDao extends SpecificationsRepository<Responsibility, String> {
	...
	@Query("select re from Responsibility re where re.riverCode=:riverCode and re.partName=:partName and re.leftRight=:leftRight ")
	public Responsibility findOnlyOneRecord(@Param("riverCode")String riverCode,
			@Param("partName")String partName,
			@Param("leftRight")String leftRight);
	
	
	@Query("select re from Responsibility re where re.riverName=:riverName and re.partName=:partName and re.leftRight=:leftRight ")
	public List<Responsibility> findByRiverNameAndPartNameAndLeftOrRight(@Param("riverName")String riverName, 
			@Param("partName")String partname, 
			@Param("leftRight")String leftright);
